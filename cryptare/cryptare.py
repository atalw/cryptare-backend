...
def update_zebpay_price():
    ...
    if result is not None:
        ...
        all_exchange_update_type['Zebpay'] = 'push'
    else:
        print("zebpay error")
...
def update_koinex_price():
    ...
    if result is not None:
        ...
        all_exchange_update_type['Koinex'] = 'push'
    else:
        print("koinex error")
...
def update_localbitcoins_price():
    ...
    for currency in currencies:
        ...
        if prices is not None and volume_data is not None:
            ...
            all_exchange_update_type['Localbitcoins'] = 'push'
        else:
...
def update_coinsecure_price():
    ...
    if result is not None:
        ...
        all_exchange_update_type['Coinsecure'] = 'push'
    else:
...
def update_pocketbits_price():
    ...
    if prices is not None:
        ...
        all_exchange_update_type['PocketBits'] = 'push'
    else:
...
def update_throughbit_price():
    ...
    if prices is not None:
        ...
        all_exchange_update_type['Throughbit'] = 'push'
    else:
...
def update_bitbns_price():
    ...
    if result is not None:
        ...
        all_exchange_update_type['Bitbns'] = 'push'
    else:
        print("bitbns error")
...
def update_coinome_price():
    ...
    if result is not None:
        for coin in coins:
            ...
            all_exchange_prices[coin]["INR"].append(result[coin]['buy_price'])
        all_exchange_update_type['Coinome'] = 'push'
    else:
        print("coinome error")
...
def update_coindelta_price():
    ...
    if result is not None:
        ...
        all_exchange_update_type['Coindelta'] = 'push'
    else:
